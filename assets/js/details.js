...
form.addEventListener("submit", async function (e) {
  ...
  await axios.patch(`${BASE_URL}/allMovies/${movieId}`, obj);
});
...
<div class="card">
  ...
  <div class="users-info">
    <div class="title">
      <h3>${item?.username ? item.username : "Jhon Doe"} <span>- ${
    item?.commentDate ? item.commentDate : "10/10/2023"
  }</span></h3>
    ...
    <div class="comment">
      <p>${item?.commentContent ? item.commentContent : "Lorem ipsum"}</p>
    </div>
  </div>
</div>
</div>
